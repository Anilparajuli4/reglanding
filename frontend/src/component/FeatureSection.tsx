...
const FeaturesSection = () => {
  return (
    <div className="flex md:mt-24 mt-5 flex-col items-center sm:mt-28  justify-center min-h-screen bg-gray-50 py-16">
      ...
      <div>
        <button className='flex bg-[#DF68FD] text-white px-4 py-2 justify-center items-center mt-24 rounded-md'>Discover All Features <span><WiDirectionRight size={35}/></span></button>
