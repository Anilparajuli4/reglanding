  ...
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8 mt-24">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center md:text-3xl text-xl font-extrabold text-gray-900">
          Hear from Our Excited Beta Applicants
        </h2>
        <p className="mt-4 text-center md:text-lg  text-gray-600">
          With lots of unique blocks, you can easily build a page without coding. Build your next landing page.
        </p>
        {/* grid gap-8 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 */}
        <div className="mt-10 flex overflow-scroll md:grid gap-8 lg:grid-cols-3 md:grid-cols-2 ">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="p-6  bg-gray-50 shadow-lg rounded-lg">
              <div className="flex px-16 py-2 items-center space-x-4">
                ...
                />
                <div>
                  <p className="md:text-xl text-[15px] font-bold text-gray-900">{testimonial.name}</p>
                  <p className="md:text-sm text-[10px] text-gray-600">{testimonial.role}</p>
                </div>
