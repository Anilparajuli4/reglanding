    ...
    <div className="text-[#fff] mt-6 py-6 ">
        <div>
            <div className="p-6 px-16 flex  flex-col gap-y-4">
                <p className="text-7xl font-semibold">Demand the Content You Crave <br/><span className="text-[#CAAFDE] inline-block mt-2">– Watch What You Want, When You Want.</span></p>
                <p className="text-[#666] ">Because Your Time Deserves Content That Speaks to You, From a Platform That Delivers.</p>
            </div>
            <div className="px-16">
