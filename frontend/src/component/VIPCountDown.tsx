...
const VIPCountdownComponent: React.FC = () => {
    ...
    return (
      <div className="md:max-w-2xl max-w-xl  mx-auto md:p-8 p-4 text-center mt-14 md:mt-24">
        ...
        <button className="w-full bg-[#DF68FD] text-white md:py-4 py-2 text-[8px]  rounded-lg md:text-xl text-lg font-semibold hover:bg-purple-600 transition-colors">
